...
| :building_construction: | **elementary OS** | [Founder Statement planning to implement](https://mastodon.online/@danirabbit/116250765623660340) |
| :building_construction: | **Midnight BSD** | [License temporarily forbids usage in Brazil, California](https://github.com/MidnightBSD/src?tab=License-1-ov-file), [until implementation finished](https://x.com/midnightbsd/status/2030992394703732872) [YouTube Video of the guy behind it](https://youtu.be/_F6lXTo6HFs)|
...
### Known Software/OS Components that plan on implementing it (Might also Include Software that calls the "age" API)
| &nbsp; | Software | Notes |
| - | - | - |
| :building_construction: | **systemd (v260+)** | [GitHub Pull Request to implement it](https://github.com/systemd/systemd/pull/40954)  - If this goes through, most Linux distros would have it by default! - [Thanks to Issue #4](https://github.com/BryanLunduke/DoesItAgeVerify/issues/4)|
